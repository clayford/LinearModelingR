...
We can visualize a Normal distribution in R using the `curve()` function.
...
- each additional finished square foot increases expected mean price by 0.04%. Or multiply by 100 to say each additional 100 finished square feet increases expected mean price by 4%.
- each additional bedroom increases expected mean price by about 4.4%
- each additional lot size acre increases expected mean price by about 0.31%
...
- Each additional acre increases expected value by about 0.3%.  (Multiplying by 1.0031 is equivalent to adding 0.3%.)
